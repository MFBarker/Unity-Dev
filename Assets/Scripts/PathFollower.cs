...
public class PathFollower : MonoBehaviour
{
    ...
    [SerializeField, Range(0, 1)] public float tdistance = 0; // distance along spline (0-1)
    ...
    { 
        ...
        set { tdistance = value / length; } //normalizing the value
    }

    private void Update()
    {
        distance += speed * Time.deltaTime;
        UpdateTransforms(math.frac(tdistance));
    }
